...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_events_modify_user_group_info_collected.sh
# 
...
deb_ensure_events_modify_user_group_info_collected()
{
	echo
	...
	deb_ensure_events_modify_user_group_info_collected_chk()
	{
		...
		l_rule_1="/etc/group,/etc/passwd,/etc/gshadow,/etc/shadow,/etc/security/opasswd"
		l_permissions_rule_1="w;a"

        # Verify ondisk rules with files
        echo -e "- Checking ondisk rules for /etc/group,/etc/passwd,/etc/gshadow,/etc/shadow,/etc/security/opasswd" | tee -a "$LOG" 2>> "$ELOG"
        eval_auditd_watcher_rule "ondisk" "$l_rule_1" "$l_permissions_rule_1"

        # Verify auditctl entry with files
        echo -e "- Checking auditctl rules for /etc/group,/etc/passwd,/etc/gshadow,/etc/shadow,/etc/security/opasswd" | tee -a "$LOG" 2>> "$ELOG"
	...
	deb_ensure_events_modify_user_group_info_collected_fix()
	{
        ...
        echo -e "- Fixing ondisk rules for /etc/group,/etc/passwd,/etc/gshadow,/etc/shadow,/etc/security/opasswd" | tee -a "$LOG" 2>> "$ELOG"
