...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_actions_as_another_user_collected.sh
# 
...
deb_ensure_actions_as_another_user_collected()
{
	echo
    ...
    deb_ensure_actions_as_another_user_collected_chk()
	{
	...
	deb_ensure_actions_as_another_user_collected_fix()
	{
