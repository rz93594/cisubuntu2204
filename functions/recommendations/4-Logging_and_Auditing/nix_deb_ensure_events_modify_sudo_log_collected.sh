...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_events_modify_sudo_log_collected.sh
# 
...
deb_ensure_events_modify_sudo_log_collected()
{
	echo
	...
	deb_ensure_events_modify_sudo_log_collected_chk()
	{
	...
	deb_ensure_events_modify_sudo_log_collected_fix()
	{
